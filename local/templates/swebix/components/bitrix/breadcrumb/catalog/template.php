...
for($index = 0; $index < $itemSize; $index++) { $title = htmlspecialcharsex($arResult[$index]["TITLE"]);}

if($itemSize <=3){$flex = "no-before";}
$strReturn .= '
<div class="uk-flex uk-flex-right@m uk-flex-center@xs" data-uk-slider="finite: true">
